  ...
  return (
    <section>
      ...
      <div className={styles.sobreNos}>
        <img src={casa} alt="Casa do Aromi d’Italia" />
        <div className={styles.sobreNos__texto}>
          <p>
            Nós do Aromi d’Italia oferecemos a vocês, nossos queridos clientes,
            a Massa Italiana Caseira mais saborosa e sofisticada do Ceará!
          ...
          <p>
            Para acompanhar as massas italianas, nossa casa possui uma reserva
